...
public class Yes_No_Type {

	public WebDriver ldriver;
	WaitHelper waithelper;
	public Yes_No_Type(WebDriver rdriver) {
		ldriver = rdriver;
	...
	"form[1]/div[1]/div[1]/div[13]/div[2]/div[1]/div[2]/button[1]/span[1]")
	...
	"form[1]/div[1]/div[1]/div[13]/div[2]/div[1]/div[5]/div[1]/div[3]/button[1]")
	...
	@FindBy(name="sections[4].passing_short_summary")
	public WebElement sectPassSumm;
	
	@FindBy(name="sections[4].failing_short_summary")
	public WebElement sectFailSumm;
	
	@FindBy(name="sections[4].passing_next_step")
	public WebElement sectPassNxtStep;
	
	@FindBy(name="sections[4].failing_next_step")
	public WebElement sectFailNxtStep;
	
	@FindBy(xpath="//body/div[@id='root']/div[1]/div[2]/main[1]"+
	"/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/div[15]/button[1]")
	...
	public void enterSectionDesc() {
		waithelper.WaitForElement(enterDesc,20);
		 enterDesc.sendKeys("This is section5 - Yes/No type");
	}
