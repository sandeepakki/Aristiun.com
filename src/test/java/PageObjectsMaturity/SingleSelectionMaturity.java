...
public class SingleSelectionMaturity {
	
	public WebDriver ldriver;
	WaitHelper waithelper;
	public SingleSelectionMaturity(WebDriver rdriver) {
		ldriver = rdriver;
	...
	"main[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/button[1]")
	public WebElement AddSection;
	
	@FindBy(name="sections[2].name")
	public WebElement sectionName;
	
	@FindBy(xpath="//body[1]/div[1]/div[1]/div[2]/main[1]/div[1]/"+
	"div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/div[7]/div[2]/div[1]/div[2]/button[1]/span[1]")
	...
	@FindBy(xpath="//body/div[@id='root']/div[1]/div[2]/main[1]/div[1]/div[1]/div[1]/"+
	"div[2]/form[1]/div[1]/div[1]/div[7]/div[2]/div[1]/div[5]/div[1]/div[3]/button[1]")
	...
	@FindBy(name="sections[2].maturity_short_summary_level_1")
	public WebElement shortSummML1;
	
	@FindBy(name="sections[2].maturity_short_summary_level_2")
	public WebElement shortSummML2;
	
	@FindBy(name="sections[2].maturity_short_summary_level_3")
	public WebElement shortSummML3;
	
	@FindBy(name="sections[2].maturity_short_summary_level_4")
	public WebElement shortSummML4;
	
	@FindBy(name="sections[2].maturity_short_summary_level_5")
	public WebElement shortSummML5;
	
	@FindBy(name="sections[2].maturity_next_steps_level_1")
	public WebElement NxtStepsLevel1;
	
	@FindBy(name="sections[2].maturity_next_steps_level_2")
	public WebElement NxtStepsLevel2;
	
	@FindBy(name="sections[2].maturity_next_steps_level_3")
	public WebElement NxtStepsLevel3;
	
	@FindBy(name="sections[2].maturity_next_steps_level_4")
	public WebElement NxtStepsLevel4;

	@FindBy(name="sections[2].maturity_next_steps_level_5")
	public WebElement NxtStepsLevel5;
	
	@FindBy(xpath="//body/div[@id='root']/div[1]/div[2]/main[1]/"+
	"div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/div[9]/button[1]")
	...
	"form[1]/div[1]/div[1]/div[8]/div[1]/div[2]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]")
	...
	public void enterSectionDesc() {
		...
		enterDesc.sendKeys("This is section3 description");
	}
	...
	public void enterfeedbackML1() {
		...
		FDML1.sendKeys("This is Section3 Feedback Maturity Level 1");
	}
	public void enterfeedbackML2() {
		waithelper.WaitForElement(FDML2,20);
		FDML2.sendKeys("This is Section3 Feedback Maturity Level 2");
	}
	public void enterfeedbackML3() {
		waithelper.WaitForElement(FDML3,20);
		FDML3.sendKeys("This is Section3 Feedback Maturity Level 3");
	}
	public void enterfeedbackML4() {
		waithelper.WaitForElement(FDML4,20);
		FDML4.sendKeys("This is Section3 Feedback Maturity Level 4");
	}
	public void enterfeedbackML5() {
		waithelper.WaitForElement(FDML5,20);
		FDML5.sendKeys("This is Section3 Feedback Maturity Level 5");
	}
	public void entershortSummML1() {
		waithelper.WaitForElement(shortSummML1,20);
		shortSummML1.sendKeys("This is Short Summary for Maturity Level 1 section3");
	}
	public void entershortSummML2() {
		waithelper.WaitForElement(shortSummML2,20);
		shortSummML2.sendKeys("This is Short Summary for Maturity Level 2 section3");
	}
	public void entershortSummML3() {
		waithelper.WaitForElement(shortSummML3,20);
		shortSummML3.sendKeys("This is Short Summary for Maturity Level 3 Section3");
	}
	public void entershortSummML4() {
		waithelper.WaitForElement(shortSummML3,20);
		shortSummML4.sendKeys("This is Short Summary for Maturity Level 4 section3");
	}
	public void entershortSummML5() {
		waithelper.WaitForElement(shortSummML5,20);
		shortSummML5.sendKeys("This is Short Summary for Maturity Level 5 section3");
	}
	public void enterNxtSteps1() {
		waithelper.WaitForElement(NxtStepsLevel1,20);
		NxtStepsLevel1.sendKeys("This is Next Steps for Maturity Level 1 Section3");
	}
	public void enterNxtSteps2() {
		waithelper.WaitForElement(NxtStepsLevel2,20);
		NxtStepsLevel2.sendKeys("This is Next Steps for Maturity Level 2 Section3");
	}
	public void enterNxtSteps3() {
		waithelper.WaitForElement(NxtStepsLevel3,20);
		NxtStepsLevel3.sendKeys("This is Next Steps for Maturity Level 3 Section3");
	}
	public void enterNxtSteps4() {
		waithelper.WaitForElement(NxtStepsLevel4,20);
		NxtStepsLevel4.sendKeys("This is Next Steps for Maturity Level 4 Section3");
	}
	public void enterNxtSteps5() {
		waithelper.WaitForElement(NxtStepsLevel5,20);
		NxtStepsLevel5.sendKeys("This is Next Steps for Maturity Level 5 Section3");
	}
